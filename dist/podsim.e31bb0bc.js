...
var $author$project$Main$Model = F4(
	function (daily_new_cases_per_100k, days_of_infection, pod_size_including_teacher, number_of_students) {
		return {daily_new_cases_per_100k: daily_new_cases_per_100k, days_of_infection: days_of_infection, number_of_students: number_of_students, pod_size_including_teacher: pod_size_including_teacher};
	});
var $author$project$Main$SliderUpdate = function (a) {
	return {$: 'SliderUpdate', a: a};
};
var $author$project$Main$TextOrSliderState = F2(
...
var $author$project$Main$textOrSliderUpdate = F3(
	function (msg, decimals, state) {
		if (msg.$ === 'SliderUpdate') {
			var value = msg.a;
			return _Utils_update(
				state,
...
var $author$project$Main$newTextOrSliderState = F2(
	function (decimals, value) {
		return A3(
			$author$project$Main$textOrSliderUpdate,
			$author$project$Main$SliderUpdate(value),
			decimals,
			A2($author$project$Main$TextOrSliderState, value, 'banana'));
	});
	...
	function (flags, url, key) {
		return _Utils_Tuple2(
			A4(
				...
				A2($author$project$Main$newTextOrSliderState, 2, 5.0),
				A2($author$project$Main$newTextOrSliderState, 0, 14.0),
				A2($author$project$Main$newTextOrSliderState, 0, 13.0),
				A2($author$project$Main$newTextOrSliderState, 0, 2000.0)),
			$elm$core$Platform$Cmd$none);
	});
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'OnUrlRequest':
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			case 'DailyNewCasesPer100K':
				var m = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							daily_new_cases_per_100k: A3($author$project$Main$textOrSliderUpdate, m, 2, model.daily_new_cases_per_100k)
						}),
					$elm$core$Platform$Cmd$none);
			case 'DaysOfInfection':
				var m = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							days_of_infection: A3($author$project$Main$textOrSliderUpdate, m, 0, model.days_of_infection)
						}),
					$elm$core$Platform$Cmd$none);
			case 'PodSizeIncludingTeacher':
				var m = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							pod_size_including_teacher: A3($author$project$Main$textOrSliderUpdate, m, 0, model.pod_size_including_teacher)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var m = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							number_of_students: A3($author$project$Main$textOrSliderUpdate, m, 0, model.number_of_students)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Main$DailyNewCasesPer100K = function (a) {
	return {$: 'DailyNewCasesPer100K', a: a};
};
var $author$project$Main$DaysOfInfection = function (a) {
	return {$: 'DaysOfInfection', a: a};
};
var $author$project$Main$NumberOfStudents = function (a) {
	return {$: 'NumberOfStudents', a: a};
};
var $author$project$Main$PodSizeIncludingTeacher = function (a) {
	return {$: 'PodSizeIncludingTeacher', a: a};
};
...
var $author$project$Main$float = function (value) {
	return $mdgriffith$elm_ui$Element$text(
		A2($cuducos$elm_format_number$FormatNumber$format, $cuducos$elm_format_number$FormatNumber$Locales$usLocale, value));
};
...
var $author$project$Main$expected = F2(
				...
				[
					...
					_List_fromArray(
						[
							...
							$author$project$Main$float(value)
						]))
				]));
	});
				...
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text(description),
							$mdgriffith$elm_ui$Element$text(':  '),
							$author$project$Main$float(value * 100.0),
							$mdgriffith$elm_ui$Element$text('%')
						]))
				]));
	});
...
var $author$project$Main$grey = A3($mdgriffith$elm_ui$Element$rgb, 0.5, 0.5, 0.5);
var $mdgriffith$elm_ui$Internal$Model$Px = function (a) {
	return {$: 'Px', a: a};
};
var $mdgriffith$elm_ui$Element$px = $mdgriffith$elm_ui$Internal$Model$Px;
var $author$project$Main$red = A3($mdgriffith$elm_ui$Element$rgb, 1.0, 0.0, 0.0);
...
var $author$project$Main$slider = F7(
	function (attrs, message, description, minVal, maxVal, step, value) {
		return A2(
...
var $author$project$Main$text = F4(
	function (attrs, message, description, value) {
		return A2(
...
var $author$project$Main$textOrSliderValidText = function (state) {
	var _v0 = $elm$core$String$toFloat(state.string);
	if (_v0.$ === 'Just') {
		var value = _v0.a;
		return true;
	} else {
...
var $author$project$Main$textSlider = F2(
	function (_v0, state) {
				...
				[
					...
					_List_fromArray(
						[
							...
							A2($elm$core$Basics$composeR, $author$project$Main$SliderUpdate, onChange),
							description,
							min,
							max,
							step,
							...
							A4(
								...
								$author$project$Main$textOrSliderValidText(state) ? _List_Nil : _List_fromArray(
									[
										$mdgriffith$elm_ui$Element$Border$color($author$project$Main$red)
									]),
								A2($elm$core$Basics$composeR, $author$project$Main$TextUpdate, onChange),
								description,
								state.string))
						]))
				]));
...
var $author$project$Main$display = function (model) {
	var pod_size_including_teacher = model.pod_size_including_teacher.value;
	var number_of_students = model.number_of_students.value;
	var number_of_pods = number_of_students / (pod_size_including_teacher - 1);
	var days_of_infection = model.days_of_infection.value;
	var daily_new_cases_per_100k = model.daily_new_cases_per_100k.value;
	var p_a_random_person_is_newly_infected_today = daily_new_cases_per_100k / 100000.0;
	var p_a_random_person_is_currently_infected = p_a_random_person_is_newly_infected_today * days_of_infection;
	var p_a_random_person_is_not_infected_today = 1.0 - p_a_random_person_is_currently_infected;
	var p_a_random_pod_has_no_infections = A2($elm$core$Basics$pow, p_a_random_person_is_not_infected_today, pod_size_including_teacher);
	var p_a_random_pod_has_at_least_one_infection = 1.0 - p_a_random_pod_has_no_infections;
	var p_no_pod_has_infections = A2($elm$core$Basics$pow, p_a_random_pod_has_no_infections, number_of_pods);
	var p_some_pods_have_infections = 1.0 - p_no_pod_has_infections;
	var p_a_random_person_is_not_newly_infected_today = 1.0 - p_a_random_person_is_newly_infected_today;
	var p_a_random_pod_gets_no_new_infections_today = A2($elm$core$Basics$pow, p_a_random_person_is_not_newly_infected_today, pod_size_including_teacher);
	var p_a_random_pod_gets_some_new_infections_today = 1.0 - p_a_random_pod_gets_no_new_infections_today;
	var expected_number_of_days_between_infections_in_a_pod = 1.0 / p_a_random_pod_gets_some_new_infections_today;
	var p_no_pods_get_new_infections_today = A2($elm$core$Basics$pow, p_a_random_pod_gets_no_new_infections_today, number_of_pods);
	var p_some_pods_get_new_infections_today = 1.0 - p_no_pods_get_new_infections_today;
	var expected_number_of_days_between_new_pod_infection_events = 1.0 / p_some_pods_get_new_infections_today;
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					A2(
					$author$project$Main$textSlider,
					{description: 'Daily new cases per 100,000 people', max: 25.0, min: 0.1, onChange: $author$project$Main$DailyNewCasesPer100K, step: $elm$core$Maybe$Nothing},
					model.daily_new_cases_per_100k),
					A2(
					$author$project$Main$textSlider,
					{
						...
						max: 25,
						min: 1,
						onChange: $author$project$Main$DaysOfInfection,
						step: $elm$core$Maybe$Just(1.0)
					},
					model.days_of_infection),
					A2(
					$author$project$Main$textSlider,
					{
						...
						max: 10000.0,
						min: 10.0,
						onChange: $author$project$Main$NumberOfStudents,
						step: $elm$core$Maybe$Just(10)
					},
					model.number_of_students),
					A2(
					$author$project$Main$textSlider,
					{
						description: 'Pod size (including teacher)',
						max: 31,
						min: 5,
						onChange: $author$project$Main$PodSizeIncludingTeacher,
						step: $elm$core$Maybe$Just(1.0)
					},
					model.pod_size_including_teacher),
					A2($author$project$Main$percent, 'Chance that a randomly selected pod has one or more infected people on day one', p_a_random_pod_has_at_least_one_infection),
					A2($author$project$Main$percent, 'Chance that one or more of the pods has one or more infected people on day one', p_some_pods_have_infections),
					A2($author$project$Main$expected, 'Expected number of calendar days between infections in one pod', expected_number_of_days_between_infections_in_a_pod),
					A2($author$project$Main$percent, 'Chance that one or more of the pods get one or more new infections on any given calendar day', p_some_pods_get_new_infections_today),
					A2($author$project$Main$expected, 'Expected number of calendar days between new infections in one or more pods', expected_number_of_days_between_new_pod_infection_events)
				])));
};
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"OnUrlChange":["Url.Url"],"OnUrlRequest":["Browser.UrlRequest"],"DailyNewCasesPer100K":["Main.TextOrSliderMsg"],"DaysOfInfection":["Main.TextOrSliderMsg"],"PodSizeIncludingTeacher":["Main.TextOrSliderMsg"],"NumberOfStudents":["Main.TextOrSliderMsg"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Main.TextOrSliderMsg":{"args":[],"tags":{"SliderUpdate":["Basics.Float"],"TextUpdate":["String.String"]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Basics.Float":{"args":[],"tags":{"Float":[]}}}}})}});
...
},{"./src/Main.elm":"src/Main.elm"}],"../../.nvm/versions/node/v14.6.0/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../.nvm/versions/node/v14.6.0/lib/node_modules/parcel/src/builtins/hmr-runtime.js","index.js"], null)
//# sourceMappingURL=/podsim.e31bb0bc.js.map